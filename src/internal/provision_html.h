...
static constexpr const char index_html3[] PROGMEM = R"rawliteral(;
  ...
  <body>
    <div class="header">
      ...
      <p id="info-text" style="opacity: 0.5"></p>
    </div>
    ...
    R"rawliteral(`;
      ...
      function submitForm(event) {
        ...
        const payload = {
          ssid: isHidden()
            ? ssid_listener.value
            : document.querySelector('input[name="ssid"]:checked')?.value,
          password: isAuth() || isHidden() ? password_listener.value : "",
          code: isCodeVisible() ? code_listener.value : "",
        };
          ...
          <div id="factory-reset-section">
            ...
            <div style="display: flex; justify-content: center; gap: 1rem; margin-top: 1.5rem;">
              <a
                ...
                id="cancelReset"
                class="btn-process"
                style="background-color: gray; text-decoration: none; display: inline-block; text-align: center; padding: 0.625rem; color: white; border-radius: 0.3125rem;"
              >
                Cancel
              </a>
            <button
